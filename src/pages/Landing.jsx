      ...
      <section id="how-it-works" style={{ padding: '80px 24px' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {[
              { num: '01', title: 'Snap', desc: 'Point your camera at any item — sneakers, watches, electronics, anything', img: '/images/landing/step-snap.png' },
              { num: '02', title: 'Identify', desc: 'AI instantly identifies brand, model, condition & market value', img: '/images/landing/step-identify.png' },
              { num: '03', title: 'Refine', desc: 'Review the AI analysis and correct anything it missed', img: '/images/landing/step-refine.png' },
              { num: '04', title: 'List', desc: 'One-tap export to eBay, Poshmark, Mercari & more', img: '/images/landing/step-list.png' },
            ].map((step, i) => (
              <div key={i} style={{
              ...
              >
                <div style={{ position: 'relative', height: 160, overflow: 'hidden' }}>
                  ...
                  <div style={{ position: 'absolute', top: 12, left: 14, fontSize: 10, fontWeight: 700, color: '#8b5cf6', textTransform: 'uppercase', letterSpacing: '0.15em', background: 'rgba(10,10,18,0.7)', borderRadius: 6, padding: '3px 8px' }}>Step {step.num}</div>
                </div>
